    ...
    return (
        <StudentLayout>
            ...
            <div className="grid gap-8 lg:grid-cols-[minmax(0,1.3fr)_minmax(20rem,0.7fr)] lg:items-start">
                <section aria-labelledby="student-welcome">
                    <p className="ui-page-eyebrow">Your library account</p>
                    <h1 id="student-welcome" className="max-w-3xl font-serif text-4xl font-semibold tracking-[-0.04em] text-[var(--library-ink)] sm:text-5xl">
                        Welcome, {auth.user.name}.
                    </h1>
                    <p className="mt-4 max-w-2xl text-pretty text-base leading-7 text-slate-600">
                        Your student account is ready. Catalogue discovery and borrowing tools will appear here as those library services are connected.
                    </p>
                ...
                <aside className="overflow-hidden rounded-2xl bg-[var(--library-ink)] text-white shadow-[0_22px_60px_rgb(20_36_46_/_0.18)]" aria-labelledby="library-card-title">
                    ...
                    <div className="p-6 sm:p-7">
                        ...
                        <dl className="mt-8 grid gap-5 border-t border-white/15 pt-6">
                            <div>
                                <dt className="text-[0.6875rem] font-bold uppercase tracking-[0.14em] text-slate-400">Name</dt>
                                <dd className="mt-1 text-sm font-semibold text-white">{auth.user.name}</dd>
                            </div>
                            <div>
                                <dt className="text-[0.6875rem] font-bold uppercase tracking-[0.14em] text-slate-400">School email</dt>
                                <dd className="mt-1 break-all text-sm font-semibold text-white">{auth.user.email}</dd>
                            </div>
                        </dl>
                    </div>
                </aside>
            ...
            <section className="mt-12 border-t border-[var(--library-line)] pt-8" aria-labelledby="student-services-title">
                <div className="grid gap-6 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)]">
                    <div>
                        <p className="ui-page-eyebrow">Next connection</p>
                        <h2 id="student-services-title" className="font-serif text-2xl font-semibold tracking-tight text-[var(--library-ink)]">
